...
## Overview
**Hemodialysis-induced leukopenia** is a transient, acute decrease in circulating leukocytes (specifically **granulocytes** and **monocytes**) observed during the initial hour of hemodialysis when using **cellophane (cuprophane)** membranes. This is not a result of cell destruction, but rather **pulmonary vascular leukostasis** (sequestration).

## Pathophysiology
*   **Trigger:** Contact between blood and **cellophane membranes** (polysaccharides).
*   **Mechanism:** 
...
*   **Question:** Which pathway is involved?
    *   **Correct:** Alternative pathway (Factor B conversion).

## References
*   **Craddock et al. (1977):** Established the link between cellophane, alternative complement activation, and pulmonary leukostasis.
*   **Textbook Correlation:** Consistent with principles of **biocompatibility** and **complement-mediated inflammation** found in *Brenner & Rector's The Kidney* regarding dialysis membrane interactions.